...
plt.savefig('plots/freezed_identify_as_transgender.png')
plt.close()
...
plt.savefig('plots/freezed_is_parent.png')
plt.close()
...
plt.savefig('plots/freezed_lgbtq_status.png')
plt.close()
...
plt.savefig('plots/freezed_personally_been_target.png')
plt.close()
...
plt.savefig('plots/freezed_personally_seen_toxic_content.png')
plt.close()
...
plt.savefig('plots/freezed_political_affilation.png')
plt.close()
...
plt.savefig('plots/freezed_race.png')
plt.close()
...
plt.savefig('plots/freezed_religion_important.png')
plt.close()
...
plt.savefig('plots/freezed_technology_impact.png')
plt.close()
...
plt.savefig('plots/freezed_toxic_comments_problem.png')
plt.close()
...
plt.savefig('plots/freezed_uses_media_forums.png')
plt.close()
...
plt.savefig('plots/freezed_uses_media_news.png')
plt.close()
...
plt.savefig('plots/freezed_uses_media_social.png')
plt.close()
...
plt.savefig('plots/freezed_uses_media_video.png')
plt.close()
