...
# train_df["annotator_id"] = train_df["annotator_id"].map(annotator2id)
...
configuration.num_labels = num_labels_glob
...
class CustomTrainer_annotators_text(Trainer):
    def compute_loss(self, model, inputs, device=device, return_outputs=False):
