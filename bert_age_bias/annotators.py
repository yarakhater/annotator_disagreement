...
bert.train(model, device, train_data_loader, mode="annotators", freeze = False)
# bert.train_trainer(model, device, train_data_loader, test_data_loader, mode="annotators", freeze = False)
...
# train_accuracy = bert.get_accuracy(model, device, train_data_loader, mode="annotators")
# test_accuracy = bert.get_accuracy(model, device, test_data_loader, mode="annotators")
