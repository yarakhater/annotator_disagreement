...
bert.train(model, device, train_data_loader, mode="text", freeze = True)


# torch.save(model.state_dict(), 'text.pth')


# train_accuracy_disagreement, train_accuracy_agreement = bert.get_accuracy(model, device, train_data_loader, mode="text")
# test_accuracy_disagreement, test_accuracy_agreement = bert.get_accuracy(model, device, test_data_loader, mode="text")
