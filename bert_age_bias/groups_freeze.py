...
bert.train(model, device, train_data_loader, mode="groups", freeze = True)
...
train_accuracy, train_accuracy_disagreement, train_accuracy_agreement = bert.get_accuracy(model, device, train_data_loader, mode="groups")
test_accuracy, test_accuracy_disagreement, test_accuracy_agreement = bert.get_accuracy(model, device, test_data_loader, mode="groups")
